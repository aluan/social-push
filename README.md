...
- 🎯 **多平台支持** - 已支持小红书（图文/长文）、知乎、微博、微信公众号、Linux.do，轻松扩展更多平台
...
├── SKILL.md                    # 技能定义文件
├── scripts/                    # 自动化脚本目录
│   ├── xiaohongshu-image.sh    # 小红书图文发布脚本
│   ├── xiaohongshu-article.sh  # 小红书长文发布脚本
│   ├── weibo.sh                # 微博发布脚本
│   └── weixin-article.sh       # 微信公众号文章发布脚本
└── references/
    ├── 小红书图文.md            # 小红书图文发布流程
    ├── 小红书长文.md            # 小红书长文发布流程
    ├── 微博.md                  # 微博发布流程
    ├── 微信公众号文章.md        # 微信公众号文章发布流程
    └── more...                  # 未来可添加更多平台
```
